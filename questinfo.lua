...
Info.ElsweyrQuests = QuestSection:new(GetString(SI_DQT_ELSWEYR), {
	QuestType:new(
		...
		QUEST_TYPE_ENUM.MISC,
		{
			...
			newQuest(SI_DQT_ELSWEYR_QUESTS_BOUNTY_06)}),
	QuestType:new(
		GetString(SI_DQT_DELVE),
		QUEST_TYPE_ENUM.MISC,
		{
...
Info.SouthElsweyrQuests = QuestSection:new(GetString(SI_DQT_SOUTH_ELSWEYR), {
	QuestType:new(
		GetString(SI_DQT_GROUP_BOSS),
		QUEST_TYPE_ENUM.MISC,
		{
			newQuest(SI_DQT_SOUTHERN_ELSWEYR_QUESTS_BOUNTY_01),
			newQuest(SI_DQT_SOUTHERN_ELSWEYR_QUESTS_BOUNTY_02),
			newQuest(SI_DQT_SOUTHERN_ELSWEYR_QUESTS_BOUNTY_03),
			newQuest(SI_DQT_SOUTHERN_ELSWEYR_QUESTS_BOUNTY_04),
			newQuest(SI_DQT_SOUTHERN_ELSWEYR_QUESTS_BOUNTY_05),
			newQuest(SI_DQT_SOUTHERN_ELSWEYR_QUESTS_BOUNTY_06)}),
	QuestType:new(
		GetString(SI_DQT_DELVE),
		QUEST_TYPE_ENUM.MISC,
		{
			newQuest(SI_DQT_SOUTHERN_ELSWEYR_QUESTS_EXPLORATORY_01),
			newQuest(SI_DQT_SOUTHERN_ELSWEYR_QUESTS_EXPLORATORY_02),
			newQuest(SI_DQT_SOUTHERN_ELSWEYR_QUESTS_EXPLORATORY_03),
			newQuest(SI_DQT_SOUTHERN_ELSWEYR_QUESTS_EXPLORATORY_04),
			newQuest(SI_DQT_SOUTHERN_ELSWEYR_QUESTS_EXPLORATORY_05),
			newQuest(SI_DQT_SOUTHERN_ELSWEYR_QUESTS_EXPLORATORY_06)}),
	QuestType:new(
		GetString(SI_DQT_NEW_MOON),
		QUEST_TYPE_ENUM.MISC,
		{
			newQuest(SI_DQT_DRAGONHOLD_QUESTS_NEW_MOON_01),
			newQuest(SI_DQT_DRAGONHOLD_QUESTS_NEW_MOON_02),
			newQuest(SI_DQT_DRAGONHOLD_QUESTS_NEW_MOON_03),
			newQuest(SI_DQT_DRAGONHOLD_QUESTS_NEW_MOON_04),
			newQuest(SI_DQT_DRAGONHOLD_QUESTS_NEW_MOON_05),
			newQuest(SI_DQT_DRAGONHOLD_QUESTS_NEW_MOON_06)})
})
...
Info.WesternSkyrimQuests = QuestSection:new(GetString(SI_DQT_WESTERN_SKYRIM), {
	QuestType:new(
		GetString(SI_DQT_GROUP_BOSS),
		QUEST_TYPE_ENUM.MISC,
		{
			newQuest(SI_DQT_WESTERN_SKYRIM_QUESTS_BOUNTY_01),
			newQuest(SI_DQT_WESTERN_SKYRIM_QUESTS_BOUNTY_02),
			newQuest(SI_DQT_WESTERN_SKYRIM_QUESTS_BOUNTY_03),
			newQuest(SI_DQT_WESTERN_SKYRIM_QUESTS_BOUNTY_04),
			newQuest(SI_DQT_WESTERN_SKYRIM_QUESTS_BOUNTY_05),
			newQuest(SI_DQT_WESTERN_SKYRIM_QUESTS_BOUNTY_06)}),
	QuestType:new(
		GetString(SI_DQT_DELVE),
		QUEST_TYPE_ENUM.MISC,
		{
			newQuest(SI_DQT_WESTERN_SKYRIM_QUESTS_EXPLORATORY_01),
			newQuest(SI_DQT_WESTERN_SKYRIM_QUESTS_EXPLORATORY_02),
			newQuest(SI_DQT_WESTERN_SKYRIM_QUESTS_EXPLORATORY_03),
			newQuest(SI_DQT_WESTERN_SKYRIM_QUESTS_EXPLORATORY_04),
			newQuest(SI_DQT_WESTERN_SKYRIM_QUESTS_EXPLORATORY_05),
			newQuest(SI_DQT_WESTERN_SKYRIM_QUESTS_EXPLORATORY_06)}),
	QuestType:new(

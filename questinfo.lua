...
Info.ElsweyrQuests = QuestSection:new(GetString(SI_DQT_ELSWEYR), {
	QuestType:new(
		...
		QUEST_TYPE_ENUM.GROUP_BOSS,
		{
			newQuest(SI_DQT_NORTHERN_ELSWEYR_QUESTS_GROUP_BOSS_DAILIES_01, SI_DQT_NORTHERN_ELSWEYR_QUESTS_GROUP_BOSS_DAILIES_01_DISPLAY),
			newQuest(SI_DQT_NORTHERN_ELSWEYR_QUESTS_GROUP_BOSS_DAILIES_02, SI_DQT_NORTHERN_ELSWEYR_QUESTS_GROUP_BOSS_DAILIES_02_DISPLAY),
			newQuest(SI_DQT_NORTHERN_ELSWEYR_QUESTS_GROUP_BOSS_DAILIES_03, SI_DQT_NORTHERN_ELSWEYR_QUESTS_GROUP_BOSS_DAILIES_03_DISPLAY),
			newQuest(SI_DQT_NORTHERN_ELSWEYR_QUESTS_GROUP_BOSS_DAILIES_04, SI_DQT_NORTHERN_ELSWEYR_QUESTS_GROUP_BOSS_DAILIES_04_DISPLAY),
			newQuest(SI_DQT_NORTHERN_ELSWEYR_QUESTS_GROUP_BOSS_DAILIES_05, SI_DQT_NORTHERN_ELSWEYR_QUESTS_GROUP_BOSS_DAILIES_05_DISPLAY),
			newQuest(SI_DQT_NORTHERN_ELSWEYR_QUESTS_GROUP_BOSS_DAILIES_06, SI_DQT_NORTHERN_ELSWEYR_QUESTS_GROUP_BOSS_DAILIES_06_DISPLAY)}),
	QuestType:new(
		GetString(SI_DQT_DELVE),
		QUEST_TYPE_ENUM.DELVE,
		{
			newQuest(SI_DQT_NORTHERN_ELSWEYR_QUESTS_DELVE_DAILIES_01),
			newQuest(SI_DQT_NORTHERN_ELSWEYR_QUESTS_DELVE_DAILIES_02),
			newQuest(SI_DQT_NORTHERN_ELSWEYR_QUESTS_DELVE_DAILIES_03),
			newQuest(SI_DQT_NORTHERN_ELSWEYR_QUESTS_DELVE_DAILIES_04),
			newQuest(SI_DQT_NORTHERN_ELSWEYR_QUESTS_DELVE_DAILIES_05),
			newQuest(SI_DQT_NORTHERN_ELSWEYR_QUESTS_DELVE_DAILIES_06)}),
	QuestType:new(
		GetString(SI_DQT_HUNT),
		QUEST_TYPE_ENUM.MISC,
		{newQuest(SI_DQT_NORTHERN_ELSWEYR_QUESTS_DRAGON_HUNT)}),
})

Info.ICQuests = QuestSection:new(GetString(SI_DQT_IC), {
	QuestType:new(
		GetString(SI_DQT_IC_M),
		QUEST_TYPE_ENUM.MISC,
		{
			newQuest(SI_DQT_IMPERIAL_CITY_01, SI_DQT_IMPERIAL_CITY_01_DISPLAY),
			newQuest(SI_DQT_IMPERIAL_CITY_02, SI_DQT_IMPERIAL_CITY_02_DISPLAY),
			newQuest(SI_DQT_IMPERIAL_CITY_03, SI_DQT_IMPERIAL_CITY_03_DISPLAY),
			newQuest(SI_DQT_IMPERIAL_CITY_04, SI_DQT_IMPERIAL_CITY_04_DISPLAY),
			newQuest(SI_DQT_IMPERIAL_CITY_05, SI_DQT_IMPERIAL_CITY_05_DISPLAY),
			newQuest(SI_DQT_IMPERIAL_CITY_06, SI_DQT_IMPERIAL_CITY_06_DISPLAY)})
})
